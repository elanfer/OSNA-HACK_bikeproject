...
files = ['backend/data/converted/baustellen_quelle_stadt_osnabrueck.osm', 
'backend/data/converted/Hauptrouten.osm', 
'backend/data/converted/Nebenrouten.osm', 
'backend/data/converted/Netzluecke.osm', 
'backend/data/converted/Radschnellrouten.osm',
'backend/data/converted/Velorouten.osm']
